...
struct RootView: View {
    ...
    @State
    private var didApplyUITestLaunchState =
        false

    @State
    private var presentsUITestPaywall =
        false
...
private struct MainTabView: View {
    ...
    private var rewardGoals:
        [RewardGoal]

    @Environment(\.scenePhase)
    private var scenePhase

    private var widgetSyncSignature:
        String {
        let cravingSignature =
            cravings
                .map { craving in
